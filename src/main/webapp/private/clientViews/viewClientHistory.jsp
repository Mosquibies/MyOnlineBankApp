...
<div class="navbar">
    ...
    <a href="/private/clientViews/viewClientHistory">Денежные операции</a>
...
<div class="row">
    ...
    <div class="main">
            <table>
                ...
                <c:forEach var="clientHistory" items="${histories}">
                <tr>
                    <td>${clientHistory.opNumber}</td>
                    <td>${clientHistory.opAction}</td>
                    <td>${clientHistory.opDate}</td>
                    </td>
                </tr>
                </c:forEach>
            </table><br><br>

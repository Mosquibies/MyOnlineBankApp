...
<div class="row">
    <div class="side">
        ...
        <h4>Ежем. платеж: ${credit.payment} </h4>
    </div>
    <div class="main">
        <h2>Выберите счет:</h2>
        <table>
            ...
            <c:forEach var="invoice" items="${invoices}">
                <tr>
                    ...
                    <td>
                        <form method="post" action="/private/clientViews/makeCreditPayment?crdNum=${credit.number}" style="display:inline;">
                            <input type="hidden" name="invNum" value="${invoice.number}">
                            <input type="submit" value="Списать платеж">
                        </form>
                    </td>
                </tr>
            </c:forEach>
